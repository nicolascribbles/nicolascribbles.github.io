...
export default function About(){
  return(
    <div className="container max-w-6xl mx-8 h-v-100">
      <div className="x-20 max-w-100 lg:mx-auto px-5 py-10 rounded-xl text-center bg-indigo-50 dark:bg-gray-700 dark:shadow-xl lg:flex justify-center overflow-y-auto">
        <div className="overflow-hidden">
          <div className="border-gray-200 border-2 rounded-lg">
            <dl>
              ...
              <div className="px-4 py-5 dark:bg-gray-900 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 dark:text-white">
                  Specialty
                </dt>
